...
const denialOverrides: Record<string, string[]> = {
  ...
  "CO-40": ["medicare-benefit-policy-manual", "no-surprises-act", "em-documentation-guidelines"],
  "PR-49": ["medicare-benefit-policy-manual", "em-documentation-guidelines", "abn-forms"],
  "CO-55": ["medicare-coverage-database", "medicare-benefit-policy-manual", "abn-forms"],
  "PR-B7": ["pecos", "nppes", "caqh-proview"],
  "CO-185": ["pecos", "nppes", "claims-processing-manual"],
  "CO-183": ["pecos", "nppes", "claims-processing-manual"],
  "CO-198": ["cms-0057-f", "medicare-coverage-database", "medicare-appeals"],
  "CO-165": ["cms-0057-f", "claims-processing-manual", "medicare-coverage-database"],
  "CO-62": ["cms-0057-f", "medicare-appeals", "claims-processing-manual"],
  "CO-107": ["ncci-policy-manual", "ama-cpt", "claims-processing-manual"],
  "CO-236": ["ncci-policy-manual", "ncci-edits", "ama-cpt"],
  "CO-231": ["ncci-policy-manual", "ncci-edits", "ama-cpt"],
  "CO-234": ["physician-fee-schedule", "claims-processing-manual", "ncci-policy-manual"],
  "CO-B10": ["physician-fee-schedule", "ncci-policy-manual", "claims-processing-manual"],
  "CO-150": ["em-documentation-guidelines", "oig-work-plan", "medicare-appeals"],
  "CO-17": ["medicare-appeals", "claims-processing-manual", "hipaa-professionals"],
  "CO-252": ["claims-processing-manual", "nucc-cms-1500", "ama-cpt"],
  MA130: ["x12-rarc", "timely-filing-medicare", "nucc-cms-1500"],
  "CO-26": ["msp-manual", "claims-processing-manual"],
  "CO-32": ["claims-processing-manual", "msp-manual"],
  "CO-253": ["physician-fee-schedule", "claims-processing-manual"],
